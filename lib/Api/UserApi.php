...
class UserApi
{
    ...
    /**
     * Operation deleteDeleteApiToken
     *
     ...
     * @return void
     */
    public function deleteDeleteApiToken($id)
    {
        $this->deleteDeleteApiTokenWithHttpInfo($id);
    }

    /**
     * Operation deleteDeleteApiTokenWithHttpInfo
     *
     * Delete an API token for the current user
     *
     * @param  string $id The API token ID to remove (required)
     ...
     */
    public function deleteDeleteApiTokenWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteDeleteApiTokenRequest($id);
    ...
    /**
     * Operation deleteDeleteApiTokenAsync
     *
     * Delete an API token for the current user
     *
     * @param  string $id The API token ID to remove (required)
     ...
     */
    public function deleteDeleteApiTokenAsync($id)
    {
        return $this->deleteDeleteApiTokenAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteDeleteApiTokenAsyncWithHttpInfo
     *
     * Delete an API token for the current user
     *
     * @param  string $id The API token ID to remove (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteDeleteApiTokenAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteDeleteApiTokenRequest($id);
    ...
    /**
     * Create request for operation 'deleteDeleteApiToken'
     *
     * @param  string $id The API token ID to remove (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function deleteDeleteApiTokenRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deleteDeleteApiToken'
            );
        }
     ...
     */
    public function getGetUsers($visible = '1', $order_by = null, $order = null, $term = null, $full = null)
    {
        list($response) = $this->getGetUsersWithHttpInfo($visible, $order_by, $order, $term, $full);
        return $response;
    }
     ...
     */
    public function getGetUsersWithHttpInfo($visible = '1', $order_by = null, $order = null, $term = null, $full = null)
    {
        $returnType = '\Swagger\Client\Model\UserCollection[]';
        $request = $this->getGetUsersRequest($visible, $order_by, $order, $term, $full);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGetUsersAsync($visible = '1', $order_by = null, $order = null, $term = null, $full = null)
    {
        return $this->getGetUsersAsyncWithHttpInfo($visible, $order_by, $order, $term, $full)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGetUsersAsyncWithHttpInfo($visible = '1', $order_by = null, $order = null, $term = null, $full = null)
    {
        $returnType = '\Swagger\Client\Model\UserCollection[]';
        $request = $this->getGetUsersRequest($visible, $order_by, $order, $term, $full);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getGetUsersRequest($visible = '1', $order_by = null, $order = null, $term = null, $full = null)
    {
